...
class CommonChannel:
    ...
    def __init__(self, id_):
        ...
        pass
        lib.rtcSetAvailableCallback(self.id, lib._wrapper_available_callback)
        lib.rtcSetBufferedAmountLowCallback(self.id, lib._wrapper_buffered_amount_low_callback)
        lib.rtcSetClosedCallback(self.id, lib._wrapper_closed_callback)
        lib.rtcSetErrorCallback(self.id, lib._wrapper_error_callback)
        lib.rtcSetMessageCallback(self.id, lib._wrapper_message_callback)
        lib.rtcSetOpenCallback(self.id, lib._wrapper_open_callback)
    ...
    def send_message(self, data, size, ):
        return _check_error(lib.rtcSendMessage, self.id, data, size, )

    def close(self, ):
        return _check_error(lib.rtcClose, self.id, )

    def delete(self, ):
        return _check_error(lib.rtcDelete, self.id, )

    def max_message_size(self, ):
        return _check_error(lib.rtcMaxMessageSize, self.id, )

    def get_buffered_amount(self, ):
        return _check_error(lib.rtcGetBufferedAmount, self.id, )

    def set_buffered_amount_low_threshold(self, amount, ):
        return _check_error(lib.rtcSetBufferedAmountLowThreshold, self.id, amount, )

    def get_available_amount(self, ):
        return _check_error(lib.rtcGetAvailableAmount, self.id, )

    def set_needs_to_send_rtcp_sr(self, ):
        return _check_error(lib.rtcSetNeedsToSendRtcpSr, self.id, )
...
class DataChannel(CommonChannel):
    ...
    def delete_data_channel(self, ):
        return _check_error(lib.rtcDeleteDataChannel, self.id, )

    def get_data_channel_stream(self, ):
        return _check_error(lib.rtcGetDataChannelStream, self.id, )

    def get_data_channel_label(self):
        return _out_string(lib.rtcGetDataChannelLabel, self.id)

    def get_data_channel_protocol(self):
        return _out_string(lib.rtcGetDataChannelProtocol, self.id)
...
class Track(CommonChannel):
    ...
    def delete_track(self, ):
        return _check_error(lib.rtcDeleteTrack, self.id, )

    def get_track_description(self):
        return _out_string(lib.rtcGetTrackDescription, self.id)

    def get_track_mid(self):
        return _out_string(lib.rtcGetTrackMid, self.id)

    def chain_rtcp_sr_reporter(self, ):
        return _check_error(lib.rtcChainRtcpSrReporter, self.id, )
...
class PeerConnection:
    ...
    def __init__(self, ice_servers=[]):
        ...
        self.assoc[self.id] = self
        lib.rtcSetDataChannelCallback(self.id, lib._wrapper_data_channel_callback)
        lib.rtcSetGatheringStateChangeCallback(self.id, lib._wrapper_gathering_state_change_callback)
        lib.rtcSetIceStateChangeCallback(self.id, lib._wrapper_ice_state_change_callback)
        lib.rtcSetLocalCandidateCallback(self.id, lib._wrapper_local_candidate_callback)
        lib.rtcSetLocalDescriptionCallback(self.id, lib._wrapper_local_description_callback)
        lib.rtcSetSignalingStateChangeCallback(self.id, lib._wrapper_signaling_state_change_callback)
        lib.rtcSetStateChangeCallback(self.id, lib._wrapper_state_change_callback)
        lib.rtcSetTrackCallback(self.id, lib._wrapper_track_callback)
    ...
    def close_peer_connection(self, ):
        return _check_error(lib.rtcClosePeerConnection, self.id, )

    def delete_peer_connection(self, ):
        return _check_error(lib.rtcDeletePeerConnection, self.id, )

    def set_local_description(self, type=ffi.NULL):
        return _check_error(lib.rtcSetLocalDescription, self.id, type, )

    def set_remote_description(self, sdp, type, ):
        return _check_error(lib.rtcSetRemoteDescription, self.id, sdp, type, )

    def add_remote_candidate(self, cand, mid, ):
        return _check_error(lib.rtcAddRemoteCandidate, self.id, cand, mid, )

    def get_local_description(self):
        return _out_string(lib.rtcGetLocalDescription, self.id)

    def get_remote_description(self):
        return _out_string(lib.rtcGetRemoteDescription, self.id)

    def get_local_description_type(self):
        return _out_string(lib.rtcGetLocalDescriptionType, self.id)

    def get_remote_description_type(self):
        return _out_string(lib.rtcGetRemoteDescriptionType, self.id)

    def get_local_address(self):
        return _out_string(lib.rtcGetLocalAddress, self.id)

    def get_remote_address(self):
        return _out_string(lib.rtcGetRemoteAddress, self.id)

    def get_selected_candidate_pair(self, local, localSize, remote, remoteSize, ):
        return _check_error(lib.rtcGetSelectedCandidatePair, self.id, local, localSize, remote, remoteSize, )

    def get_max_data_channel_stream(self, ):
        return _check_error(lib.rtcGetMaxDataChannelStream, self.id, )

    def get_remote_max_message_size(self, ):
        return _check_error(lib.rtcGetRemoteMaxMessageSize, self.id, )

    def create_data_channel(self, label, ):
        return _check_error(lib.rtcCreateDataChannel, self.id, label, )

    def add_track(self, mediaDescriptionSdp, ):
        return Track(_check_error(lib.rtcAddTrack, self.id, mediaDescriptionSdp, ))
    ...
    def get_selected_candidate_pair(self):
        max_size = _check_error(lib.rtcGetSelectedCandidatePair, self.id, ffi.NULL, 0, ffi.NULL, 0, )
        remote_buf = ffi.new(f"char[{max_size}]")
        local_buf = ffi.new(f"char[{max_size}]")
        _check_error(lib.rtcGetSelectedCandidatePair, self.id, local_buf, max_size, remote_buf, max_size, )
        return ffi.string(local_buf).decode(), ffi.string(remote_buf).decode()


def _check_error(func, *args, **kwargs):
    """
    >>> _check_error(lambda: 0)
    0
    >>> _check_error(lambda: -1)
    Traceback (most recent call last):
    ...
    pylibdatachannel.Invalid
    """
    i = func(*args, **kwargs)
    if i < 0:
...
def _out_string(func, id_):
    ...
    """
    size = _check_error(func, id_, ffi.NULL, 0)
